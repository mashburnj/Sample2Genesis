...
def rescale_output(RegTargets, ValTargets):
    ...
    for range4 in ['RS1', 'RS2', 'RS3', 'RS4']:
        RegTargets[range4] = RegTargets[range4] / 3.0
        ValTargets[range4] = ValTargets[range4] / 3.0
    ...
    for range16 in ['Multiple1', 'Multiple2', 'Multiple3', 'Multiple4',
        ...
        RegTargets[range16] = RegTargets[range16] / 15.0
        ValTargets[range16] = ValTargets[range16] / 15.0
    for range32 in ['AttackLv1', 'AttackLv2', 'AttackLv3', 'AttackLv4',
        ...
        RegTargets[range32] = RegTargets[range32] / 31.0
        ValTargets[range32] = ValTargets[range32] / 31.0
    for range128 in ['TL1', 'TL2', 'TL3', 'TL4']:
        RegTargets[range128] = RegTargets[range128] / 127.0
        ValTargets[range128] = ValTargets[range128] / 127.0
