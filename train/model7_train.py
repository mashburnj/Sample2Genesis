...
def model7_train(save_to_disk: bool, RedFeatures, RegTargets):
    # Building the model
    model7 = Sequential()
    model7.add(Dense(240, input_shape = (200,), activation='relu'))
    model7.add(Dense(220, activation='relu'))
