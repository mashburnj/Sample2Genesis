...
def model3_train(save_to_disk: bool, RedFeatures, RegTargets):
    # Building the model
    model3 = Sequential()
    model3.add(Dense(240, input_shape = (200,), activation='relu'))
    ...
    model3.add(Dense(37, activation='relu')) # 41 numerical outputs, but only 37 if we exclude release.
...
# RF, RT = model3_prep()
# model3_train(save_to_disk = True, RF, RT)