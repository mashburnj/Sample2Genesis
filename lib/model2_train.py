...
def model2_train(save_to_disk: bool, RedFeatures, RegTargets):
    # Building the model
    model2 = Sequential()
    model2.add(Dense(240, input_shape = (200,), activation='relu'))
    ...
    model2.add(Dense(37, activation='relu')) # 41 numerical outputs, but only 37 if we exclude release.
...
# RF, RT = model2_prep()
# model2_train(save_to_disk = True, RF, RT)