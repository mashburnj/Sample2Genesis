...
def model1_train(save_to_disk: bool, RedFeatures, RegTargets):
    # Building the model
    model1 = Sequential()
    model1.add(Dense(240, input_shape = (200,), activation='relu'))
    ...
    model1.add(Dense(37, activation='relu')) # 41 numerical outputs, but only 37 if we exclude release.
...
# RF, RT = model1_prep()
# model1_train(save_to_disk = True, RF, RT)